...
class SystemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create system" do
    assert_difference('System.count') do
      post systems_url, params: { system: { description: @system.description, is_active: @system.is_active, name: @system.name } }
    end
  ...
  test "should update system" do
    patch system_url(@system), params: { system: { description: @system.description, is_active: @system.is_active, name: @system.name } }
